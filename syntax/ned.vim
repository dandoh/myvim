...
syn keyword nedType             string numeric bool xml char const double
...
syn keyword nedReservedWords    connections gatesizes nocheck ref ancestor like input output default
